		...
		<table id="masterTable" cellpadding="0" cellspacing="0">
			<tr>
				<th id="masterHeader" colspan="2">
					...
					Project by Pascal Widmer, Tobias Grob
				</th>
			</tr>
			<tr id="masterContent">
				...
				<td id="masterContentMenu">
					...
					<div class="menuDiv1"><a href="Persons">All persons of interest</a></div>
					<div class="menuDiv1">Categories</div>
					<div class="menuDiv2"><a href="Cases?category=Personal Crime">Personal crimes</a></div>
					...
					<div class="menuDiv2"><a href="Cases?category=Property Crime">Property Crimes</a></div>
					<div class="menuDiv3"><a href="Cases?category=Theft">Theft</a></div>
					<div class="menuDiv3"><a href="Cases?category=Other">Other</a></div>
					<div class="menuDiv2"><a href="Cases?category=Test">Test</a></div>
